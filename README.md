...
<details>
  ...
  <ul>
    <li><a href="https://rubyonrails.org/">Rails.js</a></li>
  </ul>
</details>
...
Clone this repository to your desired folder:
  ...
  > `git clone https://github.com/Kasaija-Kenneth/react-on-rails.git`
...
Feel free to check the [issues page](https://github.com/Kasaija-Kenneth/react-on-rails/issues).
...
I would like to thank my friend [Inviiri Yusuf](https://github.com/yusufnviiri) for the support given especially when i had challenges setting up the project
...
This project is [MIT](https://github.com/Kasaija-Kenneth/react-on-rails/blob/dev/MIT.md) licensed.
